...
@Service
public class ItemKnnComparisonServiceImpl implements ItemKnnComparisonService {
	...
	@Override
	public List<Coordinates> listItemKnnComparison(List<Serie> series) throws IOException {
